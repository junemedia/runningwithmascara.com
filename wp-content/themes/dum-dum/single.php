...
<div style="clear:both;"></div>
			<div class="postfooter" style="">
				<div class="postcomments"><?php comments_number('No Comments', '<strong>1</strong> Comment', '<strong>%</strong> Comments'); ?></div> <!-- POST COMMENTS -->
...
<!-- POST FOOTER -->
				<br/><br/> <h3 class="single_h3"><?php comments_number('0 Comments', '1 Comment', '% Comments' );?></h3>
