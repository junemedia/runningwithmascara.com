<?php
/*
Plugin Name: SEO Post Teaser
Plugin URI: http://dev.wp-plugins.org/wiki/PostTeaser
Description: Post Teaser generates a preview or "teaser" of a post for the main, archive and category pages, with a link underneath to go to the full post page. It includes features to generate a word count, image count, and an estimated reading time.  This version is optimised by David Cameron Law (AKA <a href="http://www.morearnings.com/seo-dave/">SEO Dave</a>) for use with the SEO WP themes at <a href="http://www.google-adsense-templates.co.uk/">Google AdSense Templates</a>.
Version: 3.8
...
$this->default_options['full_template'] = __('<em>%word_image_count%, reading time ~ %reading_time%</em>', 'post-teaser');
...
$this->default_options['teaser_template'] = __('Continue reading <a href="%permalink%"><strong>%title%</strong></a><br /><em>%word_image_count%, reading time ~ %reading_time%</em>', 'post-teaser');

$this->default_options['target'] = '120';
...
<p><?php _e('This version is optimised for high rankings in Google and other search engines and works with the default SEO WP themes at <a href="http://www.google-adsense-templates.co.uk/">Google AdSense Templates</a> since they all have custom code to use this plugin when present.', 'post-teaser') ?></p>

<p><?php _e('If you are looking for maximum SEO impact do not change the setting below unless theres problems.', 'post-teaser') ?></p>
